...
import uk.co.syski.client.android.data.thread.entity.systemcpu.SystemCPUThreads;
...
public class SyskiCacheThread {
    ...
    public final SystemCPUThreads SystemCPUThreads = uk.co.syski.client.android.data.thread.entity.systemcpu.SystemCPUThreads.getInstance();
